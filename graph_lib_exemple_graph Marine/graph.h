...
class Graph
{
    private :
        ...
        /// La "liste" des arêtes
        std::map<int, Edge> m_edges; // à remplir avec les fichiers avec matrices, sommets...

        /// La liste des sommets
        std::map<int, Vertex> m_vertices; // idem
    ...
    public:
        ...
        void add_interfaced_vertex(int idx, double value, int x, int y, std::string pic_name="", int pic_idx=0 ); //idx indice 0 a 9 remplacer par string, nb population, x y coord,
        ...
        /// Déclaration de variables Marine
